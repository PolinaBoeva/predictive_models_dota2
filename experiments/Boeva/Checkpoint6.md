...
### 2. Модели глубокого обучения (DL)
...
- Линейные модели (Logistic Regression, LDA) показали конкурентные F1-score, но их ROC-AUC обычно ниже моделей CatBoost, что указывает на более узкую балансировку precision-recall.
...
- Глубокие модели могут быть особенно полезны, когда приоритетом является максимизация recall, но для сбалансированной работы по всем метрикам традиционные ML-решения остаются более надёжными.
